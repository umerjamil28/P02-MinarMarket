...
const {addProductListing,showProductListings, showMyProductListings, fetchProductListing, updateProductListing, showProductCategoryListings, fetchLandingPageProducts, fetchCategoryLandingPage, getRecommendedProducts, getEmbedding, fetchSimilarProducts} = require('../controllers/ProductListingController');
...
router.post('/fetch-similar-products',fetchSimilarProducts)
